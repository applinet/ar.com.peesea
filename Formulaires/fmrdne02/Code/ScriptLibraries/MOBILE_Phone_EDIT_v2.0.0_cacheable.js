...
function MOBILE_Country_OnChange() {
	...
	var strCountry = $("#MOBILE_Country").val().trim().toUpperCase();
	if(strCountry == "") {
	...
	// Pays quelconque
		...
		// Construction de la liste des sites
		$.ajax({
			url: window.location.href.strLeft(".nsf") + ".nsf/v_MOBILE_Site_Lookup_ByCountry?ReadViewEntries&RestrictToCategory=" + strCountry + "&Count=1000",

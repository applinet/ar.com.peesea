...
function TELEFON_Submit() {
	...
	if($("#TELEFON_RequestType").val() == "UPD") {
		...
		if ($("input[name='TELEFON_UpdCallLevel']:checked").val() == "Y") {
			...
			if(($("#TELEFON_UpdNewCallLevel_Value").val().trim() == "INTERNATIONAL_LIMITED") || ($("#TELEFON_UpdNewCallLevel_Value").val().trim() == "INTERNATIONAL_FULL")) {
...
function TELEFON_RequestType_OnChange(pThis) {
	...
	if($(pThis).val().trim().toUpperCase() == "UPD") {
		...
		strHTML += "<option value=\"INTERNATIONAL_LIMITED\">" + l_TELEFON_CallLevel4 + "</option>";
		strHTML += "<option value=\"INTERNATIONAL_FULL\">" + l_TELEFON_CallLevel5 + "</option>";		
		strHTML += "</select>";
...
function TELEFON_RequestStation_OnChange() {
	// Liste droit d'appel 
	if($("#TELEFON_RequestStation").val().trim() == "SERV") {
		$("#TELEFON_CallLevel").html("<input type=\"radio\" name=\"TELEFON_CallLevel\" id=\"TELEFON_CallLevel\" value=\"INTERNE\" checked=\"checked\")><label for=\"TELEFON_CallLevel\">" + l_TELEFON_CallLevel1 + "</label><input type=\"radio\" name=\"TELEFON_CallLevel\" id=\"TELEFON_CallLevel\" value=\"NATIONAL\" checked=\"checked\")><label for=\"TELEFON_CallLevel\">" + l_TELEFON_CallLevel2 + "</label><input type=\"radio\" name=\"TELEFON_CallLevel\" id=\"TELEFON_CallLevel\" value=\"INTERNATIONAL\" checked=\"checked\")><label for=\"TELEFON_CallLevel\">" + l_TELEFON_CallLevel3 + "</label>");
	}	
	else { 
		$("#TELEFON_CallLevel").html("<input type=\"radio\" name=\"TELEFON_CallLevel\" id=\"TELEFON_CallLevel\" value=\"INTERNE\" checked=\"checked\" onclick=\"TELEFON_CallLevel_OnClick(this)\")><label for=\"TELEFON_CallLevel\">" + l_TELEFON_CallLevel1 + "</label><input type=\"radio\" name=\"TELEFON_CallLevel\" id=\"TELEFON_CallLevel\" value=\"NATIONAL\" checked=\"checked\" onclick=\"TELEFON_CallLevel_OnClick(this)\")><label for=\"TELEFON_CallLevel\">" + l_TELEFON_CallLevel2 + "</label><input type=\"radio\" name=\"TELEFON_CallLevel\" id=\"TELEFON_CallLevel\" value=\"INTERNATIONAL_LIMITED\" checked=\"checked\" onclick=\"TELEFON_CallLevel_OnClick(this)\")><label for=\"TELEFON_CallLevel\">" + l_TELEFON_CallLevel4 + "</label><input type=\"radio\" name=\"TELEFON_CallLevel\" id=\"TELEFON_CallLevel\" value=\"INTERNATIONAL_FULL\" checked=\"checked\" onclick=\"TELEFON_CallLevel_OnClick(this)\")><label for=\"TELEFON_CallLevel\">" + l_TELEFON_CallLevel5 + "</label>");
	}
